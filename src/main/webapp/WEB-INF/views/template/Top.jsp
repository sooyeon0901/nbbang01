...
<link rel="shortcut icon"
	href="<%=request.getContextPath()%>/resources/images/ico/favicon.jpg">
...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/prettyPhoto.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/unslider.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/template.css" />
<script
	src="<c:url value="/resources/js/JQuery_js/jquery-3.6.0.min.js"/>"></script>
</head>
<style>
.dropbtn {
	color: white;
							...
							<div class="collapse navbar-collapse pull-left"
								...
								<ul class="nav navbar-nav">
									...
									<li class="dropdown"><a class="dropbtn"
										onclick="location.href='party.do'">파티</a>
										<div class="dropdown-content">
											<a onclick="location.href='partyBbs.do'">파티원 구하기</a> <a
												onclick="location.href='partyChat.do'">채팅</a>
										</div></li>
									<li class="dropdown"><a class="dropbtn"
										onclick="location.href='managing.do'">My</a>
										<div class="dropdown-content">
											<a onclick="location.href='mySub.do'">my구독</a> <a
												onclick="location.href='mySchedule.do'">my스케쥴</a> <a
												onclick="location.href='myReport.do'">my리포트</a> <a
												onclick="location.href='myParty.do'">my파티</a>
										</div></li>
									<li class="dropdown"><a class="dropbtn"
										onclick="location.href='recommand.do'">추천</a>
										<div class="dropdown-content">
											<a onclick="location.href='recommandBbs.do'">추천게시판</a>
										</div></li>
									<li class="login_menu" style="float: right"><a
										id="memberlogout">로그아웃</a></li>
									<li class="guide_menu" style="float: right"><a id="guide"
										href="<c:url value='/guide.do'/>">가이드</a></li>
								</ul>
							</div>
							<!-- /.navbar-collapse -->
